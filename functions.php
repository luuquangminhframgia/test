...
function mytheme_scripts() {
	...
	wp_enqueue_style( 'mythem-basic-style', get_template_directory_uri() . '/css/basic-style.css', array(), rand(0, 111111) );

	wp_enqueue_style( 'mytheme-style', get_stylesheet_uri() );

	//wp_enqueue_script( 'mytheme-boostrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js', array( 'jquery' ), '20151215', true );
